...
export const ThemedAndColored = () => {
    return (
        ...
        >
            <Paper width={125} height={125} variant="outlined" elevation={20} color={'primary'} textColor={'#8800ff'}>
                primary
            </Paper>
            <Paper width={125} height={125} variant="elevation" elevation={20} color={'secondary'}>
                secondary
            </Paper>
            <Paper width={125} height={125} elevation={20}>
                default
            </Paper>
            <Paper width={125} height={125} elevation={20} color={'#1d01cd'} textColor={'#00ff0d'}>
                custom #1d01cd
            </Paper>
        </Box>
    );
...
export const Image = () => {
    return (
        ...
        >
            <Paper width={250} height={250} elevation={20} textColor={'#FFFFFF'} imageSrc={'1.jpg'} imageOpacity={0.3}>
                Image
            </Paper>
            <Paper
                width={250}
