...
export const BasicAccordion = () => {
    ...
    return (
        <div>
            {accordionProps.map(({ id, label, details, disabled, detailsMaxRows }) => (
                <Accordion
                    key={id}
                    id={id}
                    label={label}
...
export const Expanded = () => {
    ...
    return (
        <div>
            {accordionProps.map(({ id, label, details, disabled, detailsMaxRows }, index) => (
                <Accordion
                    key={id}
                    id={id}
                    label={label}
...
export const SecondLabelAccordion = () => {
    const accordionProps = [
        ...
        },
        {
            ...
            secondaryLabel: 'Filtering has been entirely disabled for whole web server',
            details:
    ...
    return (
        <div>
            {accordionProps.map(({ id, label, details, disabled, secondaryLabel, detailsMaxRows }) => (
                <Accordion
                    key={id}
                    id={id}
                    label={label}
...
export const ThemedAndColored = () => {
    return (
        <Stack>
            ...
            <Accordion label={'custom text color'} textColor={'#D050CC'} details={`textColor="#D050CC"`} />;
        </Stack>
    );
};
