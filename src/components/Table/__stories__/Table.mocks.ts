...
export const FITNESS_DATA = [
    { id: 'FD-1', name: 'Cupcake', calories: 305, fat: 3.7, carbs: 67, protein: 4.3 },
    { id: 'FD-2', name: 'Donut', calories: 452, fat: 25.0, carbs: 51, protein: 4.9 },
    { id: 'FD-3', name: 'Eclair', calories: 262, fat: 16.0, carbs: 24, protein: 6.0 },
    { id: 'FD-4', name: 'Frozen yoghurt', calories: 159, fat: 6.0, carbs: 24, protein: 4.0 },
    { id: 'FD-5', name: 'Gingerbread', calories: 356, fat: 16.0, carbs: 49, protein: 3.9 },
    { id: 'FD-6', name: 'Honeycomb', calories: 408, fat: 3.2, carbs: 87, protein: 6.5 },
    { id: 'FD-7', name: 'Ice cream sandwich', calories: 237, fat: 9.0, carbs: 37, protein: 4.3 },
    { id: 'FD-8', name: 'Jelly Bean', calories: 375, fat: 0.0, carbs: 94, protein: 0.0 },
    { id: 'FD-9', name: 'KitKat', calories: 518, fat: 26.0, carbs: 65, protein: 7.0 },
    { id: 'FD-10', name: 'Lollipop', calories: 392, fat: 0.2, carbs: 98, protein: 0.0 },
    { id: 'FD-11', name: 'Marshmallow', calories: 318, fat: 0, carbs: 81, protein: 2.0 },
    { id: 'FD-12', name: 'Nougat', calories: 360, fat: 19.0, carbs: 9, protein: 37.0 },
