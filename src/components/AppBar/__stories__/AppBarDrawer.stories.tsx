    ...
    return (
        <Stack spacing={3}>
            <AppBar
                ...
                actions={
                    <ToggleButtonGroup value={anchor} exclusive onChange={(value) => setAnchor(value)} data={data} />
                }
            >
                {list()}
            </AppBar>
    ...
    return (
        <Stack spacing={3}>
            <AppBar
                ...
                actions={
                    <ToggleButtonGroup value={variant} exclusive onChange={(value) => setVariant(value)} data={data} />
                }
            >
                {list()}
            </AppBar>
